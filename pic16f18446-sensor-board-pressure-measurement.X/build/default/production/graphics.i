...
uint16_t foreColor = (((uint16_t)255 & 0x00F8) << 8) | (((uint16_t)255 & 0x00FC) << 3) | (((uint16_t)255 & 0x00F8) >> 3);
uint16_t backColor = (((uint16_t)0 & 0x00F8) << 8) | (((uint16_t)0 & 0x00FC) << 3) | (((uint16_t)0 & 0x00F8) >> 3);
