...
void LCD_InvertDisplay(_Bool invert);
...
void LCD_Initialize(void)
{
    ...
    LCD_WriteCmd(0xE0);
    LCD_WriteCmdData(0x3F);
    LCD_WriteCmdData(0x31);
    LCD_WriteCmdData(0x2D);
    LCD_WriteCmdData(0x2F);
    LCD_WriteCmdData(0x28);
    LCD_WriteCmdData(0x0D);
    LCD_WriteCmdData(0x59);
    LCD_WriteCmdData(0xA8);
    LCD_WriteCmdData(0x44);
    LCD_WriteCmdData(0x18);
    LCD_WriteCmdData(0x1F);
    LCD_WriteCmdData(0x10);
    ...
    LCD_WriteCmd(0xE1);
    LCD_WriteCmdData(0x00);
    LCD_WriteCmdData(0x0E);
    LCD_WriteCmdData(0x12);
    LCD_WriteCmdData(0x10);
    LCD_WriteCmdData(0x17);
    LCD_WriteCmdData(0x12);
    LCD_WriteCmdData(0x26);
    LCD_WriteCmdData(0x57);
    LCD_WriteCmdData(0x3B);
    LCD_WriteCmdData(0x07);
    LCD_WriteCmdData(0x20);
    LCD_WriteCmdData(0x2F);
    LCD_WriteCmdData(0x38);
    LCD_WriteCmdData(0x3D);
    LCD_WriteCmdData(0x3f);
...
void LCD_SetPosition(uint8_t x0, uint8_t x1, uint16_t y0, uint16_t y1)
{
    ...
    LCD_WriteCmd(0x2B);
    LCD_WriteCmdData(y0 >> 8);
    LCD_WriteCmdData(y0);
    LCD_WriteCmdData(y1 >> 8);
    LCD_WriteCmdData(y1);
